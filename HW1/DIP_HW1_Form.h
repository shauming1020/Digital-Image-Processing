...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// resultWindow
			// 
			this->resultWindow->Location = System::Drawing::Point(528, 313);
			this->resultWindow->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->resultWindow->Name = L"resultWindow";
			this->resultWindow->Size = System::Drawing::Size(303, 210);
			...
			// originalWindow
			// 
			this->originalWindow->Location = System::Drawing::Point(528, 37);
			this->originalWindow->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->originalWindow->Name = L"originalWindow";
			this->originalWindow->Size = System::Drawing::Size(303, 205);
			...
			this->beforeChart->Location = System::Drawing::Point(986, 38);
			this->beforeChart->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->beforeChart->Name = L"beforeChart";
			series1->ChartArea = L"ChartArea1";
			series1->Legend = L"Legend1";
			series1->Name = L"Series1";
			this->beforeChart->Series->Add(series1);
			this->beforeChart->Size = System::Drawing::Size(464, 206);
			...
			this->afterChart->Location = System::Drawing::Point(986, 313);
			this->afterChart->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->afterChart->Name = L"afterChart";
			series2->ChartArea = L"ChartArea1";
			series2->Legend = L"Legend1";
			series2->Name = L"Series1";
			this->afterChart->Series->Add(series2);
			this->afterChart->Size = System::Drawing::Size(464, 223);
			...
			this->ClientSize = System::Drawing::Size(1512, 608);
